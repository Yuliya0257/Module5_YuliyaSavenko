...
├── build_report.py                 # rebuilds the .docx from results & figures
...
python code/validate_ml_lib.py        # correctness tests (~5s, 11 PASS expected)
python code/tune_hyperparameters.py   # optional: regenerate hyperparameter grid
python code/sensitivity_age.py        # optional: age-window sensitivity (~30s)
python code/sensitivity_clustering.py # optional: K-means vs K-modes check (~10s)
python code/run_analysis.py           # main pipeline + subgroup fairness check
python build_report.py                # rebuild the .docx
```
...
python code/validate_ml_lib.py
python code/tune_hyperparameters.py
python code/sensitivity_age.py
python code/sensitivity_clustering.py
